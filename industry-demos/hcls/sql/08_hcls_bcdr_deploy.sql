...
UNION ALL SELECT 'GOVERNANCE', 'HCLS_CORRELATION_RESULTS', COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_CORRELATION_RESULTS
UNION ALL SELECT 'GOVERNANCE', 'HCLS_PATIENT_COMORBIDITY', COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_PATIENT_COMORBIDITY
UNION ALL SELECT 'GOVERNANCE', 'HCLS_PAYER_METRICS', COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_PAYER_METRICS
UNION ALL SELECT 'GOVERNANCE', 'HCLS_COMORBIDITY_PAIRS', COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_COMORBIDITY_PAIRS
UNION ALL SELECT 'GOVERNANCE', 'HCLS_CARE_GAPS', COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_CARE_GAPS
