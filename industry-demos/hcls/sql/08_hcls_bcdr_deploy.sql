...
UNION ALL SELECT 'HCLS_ANALYTICS', 'HCLS_CORRELATION_RESULTS', COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_CORRELATION_RESULTS
UNION ALL SELECT 'HCLS_ANALYTICS', 'HCLS_PATIENT_COMORBIDITY', COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_PATIENT_COMORBIDITY
UNION ALL SELECT 'HCLS_ANALYTICS', 'HCLS_PAYER_METRICS', COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_PAYER_METRICS
UNION ALL SELECT 'HCLS_ANALYTICS', 'HCLS_COMORBIDITY_PAIRS', COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_COMORBIDITY_PAIRS
UNION ALL SELECT 'HCLS_ANALYTICS', 'HCLS_CARE_GAPS', COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_CARE_GAPS
...
SELECT
    ...
    (SELECT COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_CORRELATION_RESULTS) AS CORRELATIONS,
    (SELECT COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_PATIENT_COMORBIDITY) AS COMORBIDITY_RECORDS,
    (SELECT COUNT(*) FROM SEM_DEV.HCLS_ANALYTICS.HCLS_PAYER_METRICS) AS PAYER_METRICS,
