...
--   SEM_DEV.HCLS_ANALYTICS - HCLS cross-system analytics
--
-- RUN AS: DATA_ADMIN
-- ============================================================================
...
CREATE SCHEMA IF NOT EXISTS SEM_DEV.HCLS_ANALYTICS
    COMMENT = 'HCLS cross-system analytics — staffing outcomes, comorbidity, payer intelligence';
...
GRANT USAGE ON SCHEMA SEM_DEV.HCLS_ANALYTICS TO ROLE DATA_ENGINEER;
GRANT USAGE ON SCHEMA SEM_DEV.HCLS_ANALYTICS TO ROLE DATA_STEWARD;
GRANT USAGE ON SCHEMA SEM_DEV.HCLS_ANALYTICS TO ROLE ANALYST;
GRANT USAGE ON SCHEMA SEM_DEV.HCLS_ANALYTICS TO ROLE MANAGER;
...
GRANT SELECT ON FUTURE TABLES IN SCHEMA SEM_DEV.HCLS_ANALYTICS TO ROLE DATA_ENGINEER;
GRANT SELECT ON FUTURE TABLES IN SCHEMA SEM_DEV.HCLS_ANALYTICS TO ROLE ANALYST;
