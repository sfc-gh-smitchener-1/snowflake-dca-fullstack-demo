...
ALTER SHARE SAP_ERP_DATA_SHARE SET ACCOUNTS = SFSENORTHAMERICA.SNOW_BCDR_PRIMARY;

-- Publish Oracle Financials Analytics Share internally
ALTER SHARE ORACLE_FINANCIALS_DATA_SHARE SET ACCOUNTS = SFSENORTHAMERICA.SNOW_BCDR_PRIMARY;

-- Publish Salesforce CRM Analytics Share internally
ALTER SHARE SALESFORCE_CRM_DATA_SHARE SET ACCOUNTS = SFSENORTHAMERICA.SNOW_BCDR_PRIMARY;

-- Publish FHIR Healthcare Analytics Share internally
ALTER SHARE FHIR_HEALTHCARE_DATA_SHARE SET ACCOUNTS = SFSENORTHAMERICA.SNOW_BCDR_PRIMARY;

-- Publish Workday HR Analytics Share internally
ALTER SHARE WORKDAY_HR_DATA_SHARE SET ACCOUNTS = SFSENORTHAMERICA.SNOW_BCDR_PRIMARY;

-- Publish ServiceNow ITSM Analytics Share internally
ALTER SHARE SERVICENOW_ITSM_DATA_SHARE SET ACCOUNTS = SFSENORTHAMERICA.SNOW_BCDR_PRIMARY;

-- Publish Enterprise Analytics Suite Share internally (All Domains)
ALTER SHARE ENTERPRISE_ANALYTICS_DATA_SHARE SET ACCOUNTS = SFSENORTHAMERICA.SNOW_BCDR_PRIMARY;
