...
SELECT
    ...
    CURRENT_TIMESTAMP() AS SNAPSHOT_TIME
FROM CURATED_DEV.SAP.FACT_PURCHASE_ORDER
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS SNAPSHOT_TIME
FROM CURATED_DEV.ORACLE.FACT_GL_JOURNAL
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS SNAPSHOT_TIME
FROM CURATED_DEV.ORACLE.FACT_AP_INVOICE
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS SNAPSHOT_TIME
FROM CURATED_DEV.SALESFORCE.FACT_OPPORTUNITY
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS SNAPSHOT_TIME
FROM CURATED_DEV.SALESFORCE.FACT_CASE
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS SNAPSHOT_TIME
FROM CURATED_DEV.FHIR.FACT_CONDITION
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS SNAPSHOT_TIME
FROM CURATED_DEV.SERVICENOW.FACT_INCIDENT
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS SNAPSHOT_TIME
FROM CURATED_DEV.SERVICENOW.FACT_CHANGE
...
SELECT
    ...
    CURRENT_TIMESTAMP() AS SNAPSHOT_TIME
FROM CURATED_DEV.SERVICENOW.FACT_PROBLEM
